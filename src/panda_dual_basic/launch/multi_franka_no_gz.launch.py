            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution([
                        FindPackageShare('panda_dual_basic'), 'launch', 'franka_no_gz.launch.py'
                    ])
                ),
                launch_arguments={
        ...
        nodes.append(
            Node(
                ...
                arguments=['--display-config', PathJoinSubstitution([
                    FindPackageShare('panda_dual_basic'), 'config', 'visualize_franka_dual_no_gz.rviz'
                ])],
                output='screen',
            )
        )
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution([
                FindPackageShare('panda_dual_basic'), 'config', 'franka_dual_no_gz.config.yaml'
            ]),
