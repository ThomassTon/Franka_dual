            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution([
                        FindPackageShare('panda_dual_basic'), 'launch', 'franka_gz.launch.py'
                    ])
                ),
                launch_arguments={
                    ...
                    'controller_name': str(config['controller'])
                }.items(),
            )
        )
        # nodes.append(
        ...
        nodes.append(
            Node(
                ...
                arguments=['--display-config', PathJoinSubstitution([
                    FindPackageShare('panda_dual_basic'), 'config', 'visualize_franka.rviz'
                ]),'-f', 'world'],
                output='screen',
            )
        )
...
def generate_launch_description():
    return LaunchDescription([
        ...
        #         FindPackageShare('panda_dual_basic'), 'config', 'franka_dual_gz.config.yaml'
        #     ]),
        #     description='Path to the robot configuration file to load',
        # ),
        # DeclareLaunchArgument(
        #     'controller_name',
        #     default_value= 'dual_arm_position_controller',
